...
import { BraceletDto } from './bracelet.dto';
import { GeneralField } from '../ProductType.enum';

export const BraceletDtoValidator = new DtoValidator<BraceletDto>({
...
export const RewritesBraceletValidation: Record<GeneralField, { visible: boolean; validation?: any[] }> = {
  [GeneralField.Sex]: {
    visible: true,
  },
