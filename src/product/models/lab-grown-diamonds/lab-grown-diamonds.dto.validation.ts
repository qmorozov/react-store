...
import { LabGrownDiamondsDto } from './lab-grown-diamonds.dto';
import { GeneralField } from '../ProductType.enum';

export const LabGrownDiamondsDtoValidator = new DtoValidator<LabGrownDiamondsDto>({
  carat: [
    Validator.required(),
...
export const RewritesLabGrownDiamondsValidation: Record<GeneralField, { visible: boolean; validation?: any[] }> = {
  [GeneralField.Sex]: {
    visible: false,
    validation: [],
  },
