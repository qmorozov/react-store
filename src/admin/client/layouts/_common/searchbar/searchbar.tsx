...
function Searchbar() {
  ...
  const renderButton = (
    <Stack direction="row" alignItems="center">
      ...
      {lgUp && <span style={{ letterSpacing: 1, color: 'black', opacity: '0.5', userSelect: 'none' }}>⌘K</span>}
    </Stack>
  );
      ...
      >
        <Box sx={{ p: 3, borderBottom: `solid 1px ${theme.palette.divider}` }}>
          <InputBase
            ...
            endAdornment={
              <span style={{ letterSpacing: 1, color: 'text.secondary', opacity: '0.5', userSelect: 'none' }}>esc</span>
            }
            inputProps={{
              sx: { typography: 'h6' },
            }}
        ...
        <Scrollbar sx={{ p: 3, pt: 2, height: 400, overflowY: 'scroll' }}>
